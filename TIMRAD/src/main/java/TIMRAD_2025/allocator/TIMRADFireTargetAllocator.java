...
import TIMRAD_2025.algorithm.TIMRADFireClustering;

public class TIMRADFireTargetAllocator extends FireTargetAllocator {

	private Collection<EntityID> priorityBuildings;
	private Collection<EntityID> targetBuildings;
	private TIMRADFireClustering fireClustering;
	...
	public TIMRADFireTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager,
		...
		case PRECOMPUTED:
			this.picker = moduleManager.getCommandPicker(
					...
					"adf.core.component.centralized.CommandPickerFire");
			break;
		case NON_PRECOMPUTE:
			this.picker = moduleManager.getCommandPicker(
					"TacticsFireStation.CommandPicker",
		...
		this.fireClustering=moduleManager.getModule("FireTargetAllocator.SampleFireClustering", "RIO2023.algorithm.RioFireClustering");
