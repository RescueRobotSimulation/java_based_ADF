...
public class TIMRADCommandExecutorFire extends CommandExecutor<CommandFire> {
	...
	public TIMRADCommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
		...
		case PRECOMPUTATION_PHASE:
			this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "RIO2023.algorithm.AstarPathPlanning");
			this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ExtActionFireFighting", "RIO2023.extaction.RIOCommandActionFireFighting");
			this.actionExtMove = moduleManager.getExtAction("CommandExecutorFire.ActionExtMove", "RIO2023.extaction.RIOActionExtMove");
			break;
		case PRECOMPUTED:
			this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "RIO2023.algorithm.AstarPathPlanning");
			this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ExtActionFireFighting", "RIO2023.extaction.RIOCommandActionFireFighting");
