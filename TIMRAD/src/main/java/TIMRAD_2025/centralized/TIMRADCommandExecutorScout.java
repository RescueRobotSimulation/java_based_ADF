...
public class TIMRADCommandExecutorScout extends CommandExecutor<CommandScout> {
	...
	public TIMRADCommandExecutorScout(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
		...
		case PRECOMPUTATION_PHASE:
			this.pathPlanning = moduleManager.getModule("CommandExecutorScout.PathPlanning", "RIO2023.algorithm.AstarPathPlanning");
			break;
		case PRECOMPUTED:
			this.pathPlanning = moduleManager.getModule("CommandExecutorScout.PathPlanning", "RIO2023.algorithm.AstarPathPlanning");
			break;
