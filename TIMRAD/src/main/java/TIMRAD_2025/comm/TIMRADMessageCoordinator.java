...
public class TIMRADMessageCoordinator extends MessageCoordinator {
  ...
  protected int[] getChannelsByAgentType(StandardEntityURN agentType,
    ...
    for (int i = 0; i < maxChannelCount; i++) {
      channels[i] = TIMRADChannelSubscriber.getChannelNumber(agentType, i,
          numChannels);
    }
    return channels;
  }
