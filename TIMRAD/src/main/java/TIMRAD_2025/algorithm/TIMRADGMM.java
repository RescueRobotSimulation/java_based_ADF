...
public class TIMRADGMM extends StaticClustering {
...
//    private List<EntityID> centerIDs;
    ...
    public TIMRADGMM(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
