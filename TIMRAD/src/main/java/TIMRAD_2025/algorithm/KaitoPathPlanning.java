...
public class KaitoPathPlanning extends PathPlanning { 

	private Map<EntityID, Set<EntityID>> graph; // 
	private Map<EntityID, Set<EntityID>> Crossgraph; //

	private EntityID from;
	private Collection<EntityID> targets;
	private List<EntityID> result;

	private Map<EntityID, Integer> crossRoads = new HashMap<>(); // 
	private Map<EntityID, Integer> edgeRoads = new HashMap<>(); // 
