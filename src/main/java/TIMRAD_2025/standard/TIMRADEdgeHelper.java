...
public class TIMRADEdgeHelper {
	...
	public TIMRADEdgeHelper(Point2D start, Point2D end, boolean passable) {
	...
	public TIMRADEdgeHelper(WorldInfo world, Edge underlyingEdge, EntityID owner) {
	...
	public boolean isNeedToClear() {
		Area area_1 = getEntity(world, neighbours.first(), Area.class);
		Area area_2 = getEntity(world, neighbours.second(), Area.class);
