...
import TIMRAD_2025.helptool.Locator;
...
public class Ruler {
    ...
    public static double getDistance(Polygon polygon1, Polygon polygon2) {
        ...
        for (int i = 0; i < count; i++) {
            j = (i + 1) % count;
            rescuecore2.misc.geometry.Point2D startPoint = new rescuecore2.misc.geometry.Point2D(polygon2.xpoints[i],
                    polygon2.ypoints[i]);
            rescuecore2.misc.geometry.Point2D endPoint = new rescuecore2.misc.geometry.Point2D(polygon2.xpoints[j],
                    polygon2.ypoints[j]);
    ...
    public static double getDistance(rescuecore2.misc.geometry.Line2D line1, rescuecore2.misc.geometry.Line2D line2) {
    ...
    public static double getDistance(rescuecore2.misc.geometry.Line2D line, rescuecore2.misc.geometry.Point2D point) {
        rescuecore2.misc.geometry.Point2D startPoint = line.getOrigin();
        rescuecore2.misc.geometry.Point2D endPoint = line.getEndPoint();

        return Line2D.ptSegDist(startPoint.getX(), startPoint.getY(), endPoint.getX(), endPoint.getY(), point.getX(),
                point.getY());
    }

    public static double getDistance(rescuecore2.misc.geometry.Line2D line, Point2D point) {
        rescuecore2.misc.geometry.Point2D startPoint = line.getOrigin();
        rescuecore2.misc.geometry.Point2D endPoint = line.getEndPoint();
    ...
    public static double getDistance(Polygon polygon, Pair<Integer, Integer> location) {
        rescuecore2.misc.geometry.Point2D point = new rescuecore2.misc.geometry.Point2D(location.first(),
                location.second());
    ...
    public static double getDistance(Polygon polygon, rescuecore2.misc.geometry.Point2D point) {
        ...
        for (int i = 0; i < count; i++) {
            int j = (i + 1) % count;
            rescuecore2.misc.geometry.Point2D startPoint = new rescuecore2.misc.geometry.Point2D(polygon.xpoints[i],
                    polygon.ypoints[i]);

            rescuecore2.misc.geometry.Point2D endPoint = new rescuecore2.misc.geometry.Point2D(polygon.xpoints[j],
                    polygon.ypoints[j]);

            rescuecore2.misc.geometry.Line2D polygonLine = new rescuecore2.misc.geometry.Line2D(startPoint, endPoint);
    ...
    public static double getDistance(rescuecore2.misc.geometry.Line2D line, Pair<Integer, Integer> pair) {
        ...
        return Line2D.ptSegDist(startPoint.getX(), startPoint.getY(), endPoint.getX(), endPoint.getY(), pair.first(),
                pair.second());
    }
