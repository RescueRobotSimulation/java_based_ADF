...
public final class ConfigConstants {
	...
	public ConfigConstants(final Config config, TIMRADWorldHelper worldHelper) {
		...
		MIN_X = worldHelper.getWorldInfo().getWorldBounds().first().first();
		MIN_Y = worldHelper.getWorldInfo().getWorldBounds().first().second();
		MAX_X = worldHelper.getWorldInfo().getWorldBounds().second().first();
