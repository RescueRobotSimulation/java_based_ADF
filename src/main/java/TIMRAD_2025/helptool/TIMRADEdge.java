...
public class TIMRADEdge {
	...
	public TIMRADEdge(Point2D start, Point2D end, boolean passable) {
	...
	public TIMRADEdge(TIMRADWorldHelper worldHelper, Edge underlyingEdge, EntityID owner) {
