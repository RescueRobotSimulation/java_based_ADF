...
public class TIMRADPoliceTargetAllocator extends PoliceTargetAllocator {

  public TIMRADPoliceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
