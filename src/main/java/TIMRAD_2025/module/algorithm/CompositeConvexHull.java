...
public class CompositeConvexHull implements IConvexHull, TIMRAD_2025.module.algorithm.fb.IConvexHull {
    ...
    //         Collection<? extends math.geom2d.Point2D> point2ds = convertPoints(points);
    ...
    private static Polygon convertPolygon2d(Polygon2D polygon2d) {
        Collection<math.geom2d.Point2D> vertices = polygon2d.getVertices();
        int[] xPoints = new int[vertices.size()];
        int[] yPoints = new int[vertices.size()];
        int i = 0;
        for (math.geom2d.Point2D point2d : vertices) {
